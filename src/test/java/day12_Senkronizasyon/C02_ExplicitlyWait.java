...
public class C02_ExplicitlyWait extends TestBase {
    ...
    public void enableTest() {
        ...
        WebElement enableKutusu= d.findElement(By.xpath("//input[@type='text']"));
        Assert.assertFalse(enableKutusu.isEnabled());

        //5. Enable butonuna tıklayın ve textbox etkin oluncaya kadar bekleyin
        d.findElement(By.xpath("//button[text()='Enable']")).click();
        ...
        WebElement itsEnabledYazielementi= d.findElement(By.xpath("//p[text()=\"It's enabled!\"]"));
